...
<?php $__env->startSection('auth_header','Ingrese Su Cuenta'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row">
            <div class="col-7">
                <div class="icheck-primary" style="display:none"  title="<?php echo e(__('adminlte::adminlte.remember_me_hint')); ?>">
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panaderia\resources\views/vendor/adminlte/auth/login.blade.php ENDPATH**/ ?>