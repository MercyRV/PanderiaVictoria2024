    ...
    <div class="<?php echo e($auth_type ?? 'login'); ?>-box">
        ...
        <div class="<?php echo e($auth_type ?? 'login'); ?>-logo">
            <a href="<?php echo e($dashboard_url); ?>">
                <img src="<?php echo e(asset(config('adminlte.logo_img'))); ?>" height="100">
                <b>PANADERIA </b>VICTORIA
            </a>
        </div>

        
        <div class="card shadow-md  card-danger">
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panaderia\resources\views/vendor/adminlte/auth/auth-page.blade.php ENDPATH**/ ?>