                    ...
                    <div class="card-body">
                      ...
                      <?php else: ?>
                        ...
                        <form method="POST" action="" autocomplete="off">
                          ...
                          <input type="hidden" id="id_cliente" name="id_cliente" value="<?php echo e($cliente['id']); ?>"/>
                          ...
                          <div class="row row-cols-1 row-cols-sm-2  row-cols-md-3 g-3">
                            ...
                            <div class="col">
                              <div class="form-group">
                                <label>Correo</label>
                                <input class="form-control form-control-sm" id="correo" name="correo" type="email"value="<?php echo e(Auth::user()->email); ?>" disabled />
                              </div>
                            </div>
                            <div class="col">
                              <div class="form-group">
                                <label>Nombre</label> 
                                <input class="form-control form-control-sm me-md-8" id="nombre" name="nombre" type="text"  value="<?php echo e(Auth::user()->name); ?>" disabled />
                              </div>
                            </div>
                            <div class="col">
                              <div class="form-group">
                                <label>Apellidos</label>
                                <input class="form-control form-control-sm" id="apellidos" name="apellidos" type="text"  value="<?php echo e($cliente['apellidos']); ?>" disabled/>
                              </div>
                            </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input class="form-control form-control-sm" id="telefono" name="telefono" type="tel" value="<?php echo e($cliente['telefono']); ?>" disabled/>
                                </div>
                              </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  <label>Fecha</label>
                                  <input class="form-control form-control-sm" id="fecha" name="fecha" type="tel" value="<?php echo e(date('Y-m-d')); ?>" disabled/>
                                </div>
                              </div>
...
<script type="text/javascript">
  ...
  function guardarpedido() { 
    ...
    let url = '<?php echo e(url('')); ?>/pedido/store';
    ...
    function redirigir(){
      window.location.href ='<?php echo e(url('')); ?>/card-checkout';
    }
...
<?php echo $__env->make('layouts.basehome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panaderia\resources\views/checkout.blade.php ENDPATH**/ ?>